...
describe("PROJECT EXPLORER::File", () => {
    ...
    describe("1 - Uploading File :: Post /project-explorer/api/File/upload", () => {
        ...
        it("1.1 - Upload: Successfully uploads a valid file", async () => {
            ...
            allure.description(
                "This test validates that a file can be uploaded to the project explorer",
            );
        ...
        it("1.2 - Upload: Fails when no file is provided", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when no file is provided",
            );
            ...
            expect(response.body.errors.file).toEqual(
        ...
        it("1.3 - Upload: Fails with an invalid Project ID", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when an invalid project ID is provided",
            );
        ...
        it("1.4 - Upload: Fails with an unsupported file type", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when an unsupported file type is provided",
            );
            ...
            expect(response.json.errors.file).toEqual(
                "The file type jpg is not allowed.",
            );
        });
    });
    ...
    describe("2 - Creating File :: Post /project-explorer/api/File", () => {
        ...
        it("2.1 - Create: Successfully processes a valid file", async () => {
            ...
            allure.description(
                "This test validates that a file can be processed in the project explorer",
            );
        ...
        it("2.3 - Create: Fails when the option field is missing", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when the option field is missing",
            );
            ...
            expect(response.json.errors.option).toEqual(
        ...
        it("2.4 - Create: Fails with an invalid File ID", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when an invalid file ID is provided",
            );
        ...
        it("2.6 - Create: Fails with an invalid Folder ID", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when an invalid folder ID is provided",
            );
    ...
    describe("3 - Getting File :: Get /project-explorer/api/File/download", () => {
        ...
        it("3.1 - Get: Successfully retrieves a valid file", async () => {
            ...
            allure.description(
                "This test validates that a file can be retrieved from the project explorer",
            );
        ...
        it("3.2 - Get: Fails with an invalid File ID", async () => {
            ...
            allure.status(response.statusCode);
            allure.parameter("HTTP Status", response.statusCode);
            allure.attachment("Response Body", response.body, {
                contentType: allure.ContentType.JSON,
            });
            ...
            expect(response.json.errors[""]).toEqual([
                `Resource ${en.invalidID} not found`,
            ]);
        });
        ...
        it("3.4 - Get: Fails when File ID is missing", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when the File ID is missing",
            );
        ...
        it("3.5 - Get: Fails when Project ID is missing", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when the Project ID is missing",
            );
    ...
    describe("4 - Deleting File :: Delete /project-explorer/api/ProjectExplorer/DeleteResource?id=${id}", () => {
        ...
        it("4.1 - Delete: Successfully deletes the first file", async () => {
            ...
            allure.description(
                "This test validates that a file can be deleted from the project explorer",
            );
        ...
        it("4.3 - Delete: Fails when file does not exist", async () => {
            ...
            allure.description(
                "This test validates that an error is returned when the file does not exist",
            );
            ...
            expect(response.body.errors[""]).toEqual(
                `Resource ${en.nonExistentID} not found`,
            );
        });
